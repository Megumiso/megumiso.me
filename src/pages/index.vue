<template>
  ...
  <v-container>
    <v-row>
      ...
      <v-col cols="12" sm="3">
        ...
        <p>TypeScript: まあまあ</p>
        <p>PHP: 少し</p>
        <p>Elixir: 無理(かじっただけ)</p>
        <p>Java: 少し(Spigotプラグイン作っただけ)</p>
        <p>Brainfuck: 俺の頭がBrainfuck</p>
      </v-col>
      <v-col cols="12" sm="3">
        <div align="center">
  ...
  <v-card hover @click="openYomiso">
    <v-card-title>読みそ</v-card-title>
    <v-container>
      <v-row>
        <v-col cols="12" sm="6">
          <img
